  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["register-register-module"], {
    ...
    function b0Bx(module, __webpack_exports__, __webpack_require__) {
      ...
      var RegisterPage = /*#__PURE__*/function () {
        function RegisterPage(auth, fb, alertController, db) {
        ...
        _createClass(RegisterPage, [{
          ...
          value: function register() {
            ...
            if (user.password == this.registerForm.controls['confirm'].value) {
              this.auth.createUserWithEmailAndPassword(user.email, user.password).then(function (userData) {
                _this.registerAlert('Success', "El usuario a sido creado correctamente");

                _this.db.database.ref('user/' + userData.user.uid).set(_this.registerForm.value);

                console.log(userData);
              })["catch"](function (e) {
                _this.registerAlert('Error', e.message);
          ...
          key: "registerAlert",
          value: function registerAlert(status, sms) {
    ...
    function x5bZ(module, __webpack_exports__, __webpack_require__) {
      ...
      RegisterPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _register_routing_module__WEBPACK_IMPORTED_MODULE_5__["RegisterPageRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"]],
